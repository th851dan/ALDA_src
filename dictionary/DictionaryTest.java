...
//	
	private static void testDict(Dictionary<String, String> dict) {
		...
		Dictionary.Entry<String, String> t = new Dictionary.Entry<String, String>("planen", "plan");
		dict.insert(t.getKey(), t.getValue());
		for (Dictionary.Entry<String, String> e : dict) {
			System.out.println(e.getKey() + ": " + e.getKey() + " search: " + dict.search(e.getKey()));
		}
	}
